    ...
    items: [
      {
        ...
        description: [
          ...
          '- Criei e refatorei grandes seções do frontend do site. Por exemplo, toda a seção Catálogo IAC, a seção de integrações para Github e Jira. Os gráficos das fichas de resultados dos benchmarks, entre outros.',
          '- Enfrentei desafios complexos para suportar novos recursos, incluindo o processamento da entrada do provedor Terraform e a geração dos planos de IaC.',
          '- Adicionado suporte para vários serviços de provedores de nuvem, como AWS, GCP e Azure.',
        ],
      ...
      },
      {
        ...
        description: [
          ...
          'Foi minha primeira abordagem à integração de serviços da AWS. Atuei como desenvolvedor Full-Stack, utilizando Node.js para o backend e React Native para o frontend.',
          'Meu principal desafio foi reutilizar ao máximo a base de código desatualizada do antigo aplicativo móvel e transformá-la em um stack atualizado. Além disso, aproveitei as vantagens da Expo para transformar o aplicativo existente em um site.',
        ],
